...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email', $user->email)); ?>" autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address', $user->address)); ?>" autocomplete="address">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\skripshit\resources\views/profile/edit.blade.php ENDPATH**/ ?>