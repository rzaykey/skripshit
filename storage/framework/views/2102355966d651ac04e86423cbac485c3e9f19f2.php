            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('product.marketplace')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    ...
                                    <p class="text-danger"><?php echo e($errors->first('marketplace')); ?></p>
                                </div>
                                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Projects\perfect\skripshit\resources\views/products/bulk.blade.php ENDPATH**/ ?>