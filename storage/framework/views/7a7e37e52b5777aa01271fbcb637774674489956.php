                        ...
                        <div class="card-header">
                            <h4 class="card-title">
                                ...
                                <div class="float-right">
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-sm">Tambah</a>
                                </div>
                            </h4>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tes\resources\views/user/user.blade.php ENDPATH**/ ?>