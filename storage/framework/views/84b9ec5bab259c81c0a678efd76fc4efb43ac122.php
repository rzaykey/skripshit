						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-50" src="<?php echo e(asset('products/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
                            ...
                            <li>
                                    <span>Stock</span> : <?php echo e($product->stock); ?></a>
							</li>
						</ul>
						<p></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.ecommerce', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Projects\perfect\skripshit\resources\views/ecommerce/show.blade.php ENDPATH**/ ?>